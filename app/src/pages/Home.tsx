...
export default function Home() {
  ...
  return (
      <section className="min-w-lg p-2 h-fit lg:mt-[10%] mt-[30%]">
            <h1 className="text-foreground font-black lg:text-4xl text-3xl flex items-center justify-center gap-5">
              Bem vindo ao simpleQuiz
              <CircleQuestionMark className="w-10 h-10"/>
            </h1>
        <p className="text-foreground font-light lg:text-2xl text-wrap text-xl text-center my-2 w-4/5 text-certer m-auto">
            Teste suas conhecimentos gerais sobre assuntos comuns
        </p>
          <div className="w-full flex sm:flex-row flex-col items-center justify-around gap-5 my-5">
